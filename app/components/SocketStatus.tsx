...
export function SocketStatus() {
  ...
  const statusConfig = {
    connected: { icon: Wifi, text: "Connected", className: "bg-green-100 text-green-700 border-green-200" },
    reconnecting: { icon: RefreshCw, text: "Reconnecting", className: "bg-yellow-100 text-yellow-700 border-yellow-200" },
    offline: { icon: WifiOff, text: "Offline", className: "bg-red-100 text-red-700 border-red-200" },
  }
